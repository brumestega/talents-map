 ...
 * Mappatura per arcano:
 *   keyword     ← "Verbo" (il motto della lama)
 *   descrizione ← descrizione principale (chi è / cosa rappresenta)
 *   ombra       ← sezione "Conflitto"
 *   dono        ← sezione "Talento" (+ "Soluzione"/"Equilibrio" se presenti)
 * Le sezioni "Genealogia" e "Domande" dei .docx NON sono incluse qui (molto
 * estese/cliniche): si potranno esporre in una futura "scheda completa".
 * Eccezioni redatte a mano: #2 La Papessa (Verbo assente nel sorgente) e
 * #20 Il Giudizio (nel .docx il Verbo era erroneamente quello de Il Matto).
